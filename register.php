...
<body>
    ...
    <main>
        <div class="position-absolute top-50 start-50 translate-middle login-form">
            <div class="container">
                <form action="./functions/register.php" method="get" class="loginform">
                    <h1 align="center"><i class="fa-solid fa-right-from-bracket"></i>สมัครสมาชิก</h1>
                    <input type="text" name="username" id="username" placeholder="ชื่อผู้ใช้งาน" require><br>
                    <input type="text" name="email" id="email" placeholder="อีเมล" require><br>
                    <input type="password" name="password" id="password" placeholder="รหัสผ่าน" require><br>
                    <input type="password" name="cpassword" id="cpassword" placeholder="ยืนยันรหัสผ่าน" require><br>
                    <script>
                        function makeaction() {
                    ...
                    <button class=" login btn btn-primary">เข้าสู่ระบบ</button><br>
                        <span>เป็นสมาชิกอยู่แล้ว?</span><a href="./login.php" style="text-decoration:none;">&nbsp;เข้าสู่ระบบ</a>
                </form>
            </div>
        </div>
